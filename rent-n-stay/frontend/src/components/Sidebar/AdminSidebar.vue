    ...
    >
      ...
      >
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
          ...
          <li v-if="is_SAdmin" class="items-center">
          ...
          <li class="items-center">
            <router-link to="/admin/client" v-slot="{ href, navigate, isActive }">
              <a
                :href="href"
                @click="navigate"
                class="text-xs uppercase py-3 font-bold block"
          ...
          <li class="items-center">
            ...
            >
              ...
              >
                <i
                  class="fas fa-house-user mr-2 text-sm"
                  :class="[isActive ? 'opacity-75' : 'text-blueGray-300']"
                ></i>
                Manage Owner
              </a>
          ...
          <li class="items-center">
            ...
            >
              ...
              >
                <i
                  class="fas fa-laptop-house mr-2 text-sm"
                  :class="[isActive ? 'opacity-75' : 'text-blueGray-300']"
                ></i>
                Manage Place
              </a>
...
export default {
  ...
  computed: {
    is_SAdmin : function(){ return localStorage.getItem('role') == 0}
  },
  methods: {
