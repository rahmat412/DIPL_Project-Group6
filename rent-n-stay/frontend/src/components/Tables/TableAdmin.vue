      ...
      <table class="items-center w-full bg-transparent border-collapse">
        ...
        <tbody>
          <tr v-for="admin in admins" :key="admin.adminID">
            ...
            >
                <TableDropdown :id="admin.adminID"/>
            </td>
          </tr>
        </tbody>
      </table>
...
import TableDropdown from "@/components/Dropdowns/TableDropdown/admin.vue";
import ModalAdd from '@/components/Modal/ModalAddAdmin.vue';
