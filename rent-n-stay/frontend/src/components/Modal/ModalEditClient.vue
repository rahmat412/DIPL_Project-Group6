  ...
  methods: {
    async getClient() {
      try {
        await axios.get(
          ...
          this.state.id = response.data.clientID;
          this.state.name = response.data.clientName;
          this.state.email = response.data.clientEmail;
          this.state.password = response.data.clientPassword;
          this.state.phone = response.data.clientPhone;
        })
      } catch (err) {
        console.log(err);
      }
    ...
    async editClient() {
      ...
      try {
        ...
        this.sAlert("success","Yeay..","Editing Client Success");
        this.close();
      } catch (err) {
        console.log(err);
        this.sAlert("error","Oops..","Editing Client Failed");
      }
    },
